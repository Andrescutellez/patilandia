...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden bg-[#1d256d]">
      <Image
      ...
      <div className="relative mx-auto flex min-h-[300px] max-w-7xl items-end px-6 py-8 sm:min-h-[420px] sm:px-10 sm:py-10 lg:min-h-[620px] lg:px-14 lg:py-14">
